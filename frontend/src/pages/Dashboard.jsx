                                ...
                                <div className="flex-grow min-w-0">
                                    ...
                                    <div className="text-emerald-400/80 text-[11px] font-medium">
                                        {msg.isCash && msg.amount === 0
                                            ? <>hat <span className="text-amber-400 font-bold">€{msg.cashAmount}</span> bar gespendet</>
                                            : <>hat <span className="text-white font-bold">{msg.amount} m²</span> gespendet</>
                                        }
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative h-5 bg-white/[0.04] rounded-full overflow-hidden border border-white/[0.04] flex">
                                    <motion.div
                                        ...
                                        style={{ background: 'linear-gradient(90deg, #065f46, #10b981, #34d399)', boxShadow: '0 0 30px rgba(16,185,129,0.25)' }}
                                    >
                                    ...
                                    {goalReached && goldPercent > 0 && (
                                        <motion.div
                                            ...
                                            style={{ background: 'linear-gradient(90deg, #8a6d2b, #c9a84c, #d4b85c)', boxShadow: '0 0 25px rgba(201,168,76,0.3)' }}
                                        >
                        ...
                        {activeUnits.length > 0 && (
                            <div className="relative">
                                <div className="flex items-center justify-between text-[10px] text-white/20 font-bold uppercase tracking-[0.2em] px-4 mb-4">
                                    <span className="flex items-center gap-2">🕌 Aktuelle Fläche – Moschee Abo</span>
                                ...
                                <div className="grid grid-cols-5 md:grid-cols-8 lg:grid-cols-10 gap-6 w-full relative overflow-hidden p-14 rounded-[4rem] border border-emerald-900/20"
                                    style={{ background: 'linear-gradient(180deg, #030f0a 0%, #040804 50%, #050505 100%)', boxShadow: '0 0 120px rgba(16,185,129,0.03), inset 0 1px 0 rgba(16,185,129,0.04)' }}
                                >
